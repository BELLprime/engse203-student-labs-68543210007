...
|---|---|---|---|---|
| 12:31 | B2 | "กรองรายการ requesterName หรือ details มีข้อความที่พิมพ์ (ไม่สนพิมพ์เล็กใหญ่)" | อธิบายการใช้ `.toLowerCase()` และ `.includes()` ร่วมกันเพื่อค้นหาข้อความ และให้โค้ดตัวอย่างเงื่อนไขการกรอง | ตรวจสอบโค้ด ทำความเข้าใจการทำงาน และนำมาประยุกต์ใช้ในแอป ทดสอบแล้วหน้าเพจกรองคำได้ถูกต้อง |
